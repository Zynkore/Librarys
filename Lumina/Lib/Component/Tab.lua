...
function Tab.new(window, data)
    ...
    self.Button.Parent = window.Main:FindFirstChild("Tbar"):FindFirstChild("TabHolder") or window.Main:FindFirstChild("Tbar")
...
function Tab:Section(data)
    local SectionModule = loadstring(game:HttpGet("https://raw.githubusercontent.com/MarkhubOfc/Librarys/main/Lumina/Lib/Element/Section.lua"))()
